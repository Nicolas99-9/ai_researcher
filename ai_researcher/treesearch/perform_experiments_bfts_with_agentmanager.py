...
def perform_experiments_bfts(config_path: str):
    ...
    if cfg.generate_report:
        ...
        summary_files = [
            (cfg.log_dir / "draft_summary.json", draft_summary),
            (cfg.log_dir / "baseline_summary.json", baseline_summary),
            (cfg.log_dir / "research_summary.json", research_summary),
            (cfg.log_dir / "ablation_summary.json", ablation_summary),
        ]
